...
# st.session_state.unmeteredFuelPressure = False
# st.session_state.meteredFuelPressure = False
...
# unmeteredFuelPressureStatus = True
...
def main():
    ...
    """, unsafe_allow_html=True)
    # st.write(st.session_state.run_time)
